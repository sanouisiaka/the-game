      ...
      return (
        <div className='h-full justify-around flex flex-row space-between items-center'>
          <div className='w-1/6 flex justify-center'>
            <OddBox odd={fixture.winnerBets.find(b => b.winOption === 'HOME')?.odd} />
          </div>
          <div className='w-1/6 flex justify-center'>
            <OddBox odd={fixture.winnerBets.find(b => b.winOption === 'DRAW')?.odd} />
          </div>
          <div className='w-1/6 flex justify-center'>
            <OddBox odd={fixture.winnerBets.find(b => b.winOption === 'AWAY')?.odd} />
          </div>
        </div>
      );
    }
