Feature: Create a user
  ...
  Scenario: Creating a user fail because the user has no lastname
    Given the email "william@gmail.com" is not use
    When I create a user "Will" "" with email "william@gmail.com"
    Then the user creation fail because the user has no lastname

  Scenario: Creating a user fail because the user has no firstname
    Given the email "william@gmail.com" is not use
    When I create a user "" "Smith" with email "william@gmail.com"
